...
const ctrl = __importStar(require("./countries.controller"));
const router = (0, express_1.Router)();
router.get("/", auth_middleware_1.requireAdmin, ctrl.list);
router.get("/states", auth_middleware_1.requireAdmin, ctrl.listStates);
router.get("/:id", auth_middleware_1.requireAdmin, ctrl.getById);
router.post("/", auth_middleware_1.requireAdmin, ctrl.create);
router.put("/:id", auth_middleware_1.requireAdmin, ctrl.update);
