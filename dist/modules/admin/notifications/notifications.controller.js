...
const service = __importStar(require("./notifications.service"));
async function list(req, res) {
    try {
        ...
        return (0, admin_response_1.sendError)(res, 500, "Failed to list notifications", e?.message);
    }
}
async function getCount(req, res) {
    try {
        ...
        return (0, admin_response_1.sendError)(res, 500, "Failed to get notification count", e?.message);
    }
}
