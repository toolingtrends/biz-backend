...
exports.DEFAULT_MODULE_STATUSES = exports.MODULE_DEFINITIONS = void 0;
/** Module catalog + default status/settings (icons are Lucide name strings). */
...
/** Default status + per-module settings (merged with persisted overrides). */
exports.DEFAULT_MODULE_STATUSES = {
    "user-management": {
        status: "active",
        settings: [
