...
export async function findOrCreateUser(userData: {
  ...
  if (user) {
    ...
    if (data.venueCountry !== undefined) updateData.venueCountry = data.venueCountry;
    if (data.venueZipCode !== undefined) updateData.venueZipCode = data.venueZipCode;
    if (data.venueEmail !== undefined) updateData.venueEmail = data.venueEmail;
    if (data.venueWebsite !== undefined) updateData.venueWebsite = data.venueWebsite;
    if (data.maxCapacity !== undefined) updateData.maxCapacity = data.maxCapacity;
    if (data.totalHalls !== undefined) updateData.totalHalls = data.totalHalls;
    if (data.amenities !== undefined) updateData.amenities = data.amenities;
    if (data.venueImages !== undefined) updateData.venueImages = data.venueImages;
    if (data.venueVideos !== undefined) updateData.venueVideos = data.venueVideos;
    if (data.floorPlans !== undefined) updateData.floorPlans = data.floorPlans;
    if (data.virtualTour !== undefined) updateData.virtualTour = data.virtualTour;
    if (data.basePrice !== undefined) updateData.basePrice = data.basePrice;
    if (data.venueCurrency !== undefined) updateData.venueCurrency = data.venueCurrency;
